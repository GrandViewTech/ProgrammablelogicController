				...
				if (g instanceof Graphics2D)
					{
						...
						float xc = width - 1;
						g2d.draw(new Line2D.Float(xc, (ApplicationConstant.SECTION_HEIGHT / 2) - ApplicationConstant.CUSTOM_BORDER_HEIGTH_OFFSET, xc, (ApplicationConstant.SECTION_HEIGHT / 2) + ApplicationConstant.CUSTOM_BORDER_HEIGTH_OFFSET));
					}
			}
