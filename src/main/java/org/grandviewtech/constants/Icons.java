...
public interface Icons
	{
		...
		ImageIcon	CUT		= new ImageIcon("icons" + File.separator + "cut.png");
		ImageIcon	SETTING	= new ImageIcon("icons" + File.separator + "setting.png");
		ImageIcon	EDIT	= new ImageIcon("icons" + File.separator + "edit.png");
